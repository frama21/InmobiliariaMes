 ...
 * @author Pau Alario
 * 
 * Crear Piso campo superficie total negativo
 */
    ...
    List <Piso> pisos;
	 ...
	 @Before
	    public void inicializar() {
            ...
            pi = new Piso("12","calle","localidaddd", "01/01/2013", supTotal, "V", "2", ase,cli);
            try{
    			...
    			piso.setCampos("12","calle","localidaddd", "01/01/2013", supTotal, "V", "2");
	...
	public void testCrearPisoJDialog() {
			...
			try {
				...
				for (int i = 0; i < pisos.size(); i++){
					assertFalse("El piso no debería de haberse creado con campo superficie total negativo", 
